...
2. go inside the ckeditor5 targeted folder
3. Run `npm i` if not already
4. Run `npm run publish:ckeditor`
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `c2kzrziuchsv-w6o8penm7fa5`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
